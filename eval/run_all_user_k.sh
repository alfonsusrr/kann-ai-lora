...
scripts=(
    "python3 eval_fix_tmp.py --model kanna-v4 --index_user kanna-user --index_name akizuki-kanna --character Akizuki Kanna --embed_model mxbai-embed-large-v1 --modelfile_name ModelfileKanna --eval_dataset user_knowledge_data.json --output_report kanna-report-user-knowledge-3.json --checkpoint kanna-user-knowledge.txt --user_know_eval --user_convo user_convo.json --device $device", 
    "python3 eval_fix_tmp.py --model natsume-v4 --index_user natsume-user --index_name shiki-natsume --character Shiki Natsume --embed_model mxbai-embed-large-v1 --modelfile_name ModelfileNatsume --eval_dataset user_knowledge_data.json --output_report natsume-report-user-knowledge-3.json --checkpoint natsume-user-knowledge.txt --user_know_eva --user_convo user_convo.json --device $device",
    "python3 eval_fix_tmp.py --model nene-v4 --index_user nene-user --index_name ayachi-nene --character Ayachi Nene --embed_model mxbai-embed-large-v1 --modelfile_name ModelfileNene --eval_dataset user_knowledge_data.json --output_report nene-report-user-knowledge-3.json --checkpoint nene-user-knowledge.txt --user_know_eva --user_convo user_convo.json --device $device",
    "python3 eval_fix_tmp.py --model tsumugi-v4 --index_user tsumugi-user --index_name shiiba-tsumugi --character Shiiba Tsumugi --embed_model mxbai-embed-large-v1 --modelfile_name ModelfileTsumugi --eval_dataset user_knowledge_data.json --output_report tsumugi-report-user-knowledge-3.json --checkpoint tsumugi-user-knowledge.txt --user_know_eva --user_convo user_convo.json --device $device"
)
